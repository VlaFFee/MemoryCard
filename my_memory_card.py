...
question_list = []
q1 = Question('2+2', '4', '3', '2', '6')
question_list.append(q1)
q2 = Question('5+5', '10', '8', '2', '9.999999')
question_list.append(q2)
q3 = Question('250+50', 'Триста', '300', 'Три сотни', 'Многа')
question_list.append(q3)
q4 = Question('Ты человек?', 'Я крутой чел', 'Нет', 'Да', 'Мб')
question_list.append(q4)
q5 = Question('2+4002+1000241+0.111042144+20048.0013*20045:2077', 'Чё?', '...', '..', '.')
question_list.append(q5)
q6 = Question('У тебя есть пк или ноут?', 'Нет блин, я просто программирую на унитазе в микроволновке', 'Нит', 'Дя', 'Низнаю')
question_list.append(q6)
q7 = Question('У тебя есть имя?', 'КАНЕШНА', 'Нит', 'Нет', 'Кому оно нужно')
question_list.append(q7)
q8 = Question('Любишь матешу?', 'Нет конечно', 'Да, я не из вашего мира вообще!', 'Да', 'Baldy?')
